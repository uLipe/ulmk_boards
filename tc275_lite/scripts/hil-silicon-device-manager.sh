...
export ULMK_HIL_BREAK_DONE="${ULMK_HIL_BREAK_DONE:-silicon_device_manager_done}"
exec "${ULMK_ROOT}/tools/hil/hil_ramlog_expect.sh" \
	"${1:-/home/ulipe/fun/build/ulipe-tricore-tc275_lite/ulmk}" \
	"${HIL_DEVICE_MANAGER_EXPECT:-SILICON_DEVICE_MANAGER: PASS}" \
	"SILICON_DEVICE_MANAGER: FAIL"
