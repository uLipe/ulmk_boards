...
#define LV_STDARG_INCLUDE       <stdarg.h>
    ...
    /*
     * tlsf pool in SDRAM after dual LTDC FBs (board_config ULMK_BOARD_LVGL_*).
     * Numeric literals so lv_conf does not pull board headers into every TU.
     *   FB = 1024*600*2 = 0x12C000; heap @ 0xC0000000 + 2*FB = 0xC0258000
     */
    #define LV_MEM_SIZE   (5U * 1024U * 1024U)
    #define LV_MEM_ADR    0xC0258000U
...
/* SW-only on this board — DMA2D not required for ~panel-rate light scenes. */
...
#define LV_USE_ASSERT_MALLOC        0   /**< Off: opa_layer OOM must not halt */
